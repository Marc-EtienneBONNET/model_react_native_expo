...
export function FadeBlockRight({
	...
	return (
		<Box width={20} position={"absolute"} top={0} bottom={0} right={0}>
			<Svg width="100%" height={"100%"}>
				<Defs>
					<SvgLinearGradient id="fadeLR" x1="1" y1="0" x2="0" y2="0">
						<Stop offset="0" stopColor={_fadeColor} stopOpacity="1" />
						<Stop offset="1" stopColor={_fadeColor} stopOpacity="0" />
					</SvgLinearGradient>
				</Defs>
				<Rect width="100%" height={"100%"} fill="url(#fadeLR)" />
			</Svg>
		</Box>
	);
}
